...
-Do not invert names,date,princes,comanies,attachments,or facts
-keep the email natural and cocise
-Include an appropraite greeting and closing.
output exactly:
SUBJECT:<subject>
BODY:
<email body>
...
for attempt in range(4):
  try:
  with urlib.request.urlopen(req,timeout=10)as response:
